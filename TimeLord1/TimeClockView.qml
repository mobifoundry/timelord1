...
Rectangle {
    ...
    function calulateElapsedTime() {
        ...
        elapsedHours = Math.floor(
                    milliSecondsRemaining / hour) //Milliseconds still remaining for - lessthan an hour's worth,Get 1 minute in milliseconds
        milliSecondsRemaining = milliSecondsRemaining % hour
        elapsedMinutes = Math.floor(
                    milliSecondsRemaining
                    / minute) //Milliseconds still remaining for -less than a minute's worth.
        milliSecondsRemaining = milliSecondsRemaining % minute
        elapsedSeconds = Math.round(milliSecondsRemaining / second)
