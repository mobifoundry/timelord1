...
ScrollViewStyle {
    ...
    readonly property color textColor: FlatStyle.defaultColor
    ...
    property Component rowDelegate: Item {
        ...
        Rectangle {
            ...
            color: selected ? selectedColor : FlatStyle.frameColor
    ...
    property Component itemDelegate: Item {
        ...
        Text {
            ...
            color: !control.enabled ? FlatStyle.disabledColor :
                   styleData.hasActiveFocus ? FlatStyle.focusedColor :
                   styleData.textColor
