...
var author   = " Louis Meadows <br> lou@positivelyfrontstreet.com <br> louis.meadows@mobifoundry.com <br>";
var company  = " Positively Front Street, Inc <br> www.positivelyfrontstreet.com <br> DBA mobiFoundry <br> www.mobifoundry.com"
// This          ^^    should not be translated in my opinion   RNM

var TimeLord = " TimeLord1 ";
var TimeLordES = "TiempoSenor1";

var VERSION  = " V115 LPM29JAN10 ";
...
var WARN007FN = WARN007  = "Syötä hinta"; //Please enter the Price!"; 

var WARN008  = "clear menu failed";
var WARN008ES  = "claro menu no hace";
// Literally WARN008es means does not clear menu.  I think that is good. RNM
var WARN008SW  = "menytömningen misslyckades"; // "clear menu failed"; 
var WARN008FN = WARN008  = "Menun tyhjentäminen epäonnistui"; //clear menu failed";  
...
var WARN009FN = WARN009  = "Syötä työn kuvaus"; //enter Job task to complete";  
...
var LBL002FN = LBL002   = " Syötä ensin työ, sitten tehtävät, työmäärä ja materiaalit"; //first enter a Job then Task, Labor and Materials "; 

var LBL003   = "Enter Material";
var LBL003ES   = "Introduzca Material";
var LBL003SW   = "klicka på enter för material"; // "Enter Material";  
var LBL003FN = LBL003   = "Syötä materiaali"; //Enter Material";  
...
var LBL004FN = LBL004   = "den anställdas namn eller nummer,  Työntekijän nimi tai numero"; //employee name or number"; 

var LBL005   = "<br> Written By";
var LBL005ES   = "Escrito Para"
var LBL005SW   = "<br>skrivet av"; // "<br> Written By"; 
var LBL005FN = LBL005   = " Tekijä"; //Written By"; 

var LBL006   = " TimeSheet ";
var LBL006ES   = " Hoja de tiempo ";
var LBL006SW   = "tidsschema"; // " TimeSheet "; 
var LBL006FN = LBL006   = " Aikalista"; //TimeSheet "; 
...
var LBL007FN = LBL007   = "materiaalilasku"; // Bill of Materials: $"; 
...
var LBL008FN = LBL008   = "Materiaalin nimi tai numero"; // Materials name or number"; 
