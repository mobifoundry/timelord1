...
public:
    ...
    Q_PROPERTY( int cuttingLogId READ cuttingLogId WRITE setCuttingLogId NOTIFY cuttingLogIdChanged )
    ...
    int cuttingLogId() const;
    void setCuttingLogId(const int cuttingLogId);
